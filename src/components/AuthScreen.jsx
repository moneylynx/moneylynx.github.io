...
// TODO: GOOGLE-LOGIN — vratiti `signInGoogle` u import kad bude potrebno
import { signIn, signUp /*, signInGoogle */ } from '../lib/supabase.js';
import { Ic, LynxLogo, LynxLogoWhite } from './ui.jsx';
...
export default function AuthScreen({ C, t, lang, onLangChange, onSuccess }) {
  ...
  // TODO: GOOGLE-LOGIN — handler za Google prijavu, otkomentirati kad bude potreban
  // (treba i nativni plugin @codetrix-studio/capacitor-google-auth + Firebase config za Android)
  /*
    ...
    <div style={{ width:'100%', minHeight:'100vh', background:C.bg, display:'flex', alignItems:'center', justifyContent:'center', padding:24 }}>
      <div style={{ width:'100%', maxWidth:360 }}>
        ...
        <div style={{ textAlign:'center', marginBottom:32 }}>
          ...
          <h1 style={{ fontSize:24, fontWeight:700, color:C.text }}>{t('Moja Lova')}</h1>
          <p style={{ fontSize:13, color:C.textMuted, marginTop:4 }}>
            {mode==='login' ? t('Osobne financije bez kompliciranja') : t('Kreiranje računa')}
          </p>
        </div>

        {/* TODO: GOOGLE-LOGIN — Google button + "ili" separator, otkomentirati kad bude potrebno */}
        {/*
